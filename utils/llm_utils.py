...
def _format_prompt(template: str, **kwargs):
    try:
...
class LLMUtils:
    ...
    def call(self, prompt: str, system_prompt: str = "") -> str:
        ...
        ] if system_prompt != "" else [{"role": "system", "content": prompt}]
        return self.model.invoke(messages).content

    def chain(self, input_txt: str, prompts: List[str]) -> str:
        result = input_txt
    ...
    def route(self, input_text: str, routes: Dict[str, str]) -> str:
